...
- For the error metric, we consider two possible cases: a simpler one in which the continuum parametrization is known and more complicated one in which it is necessary to choose a continuum parametrization from a set of possibilites.

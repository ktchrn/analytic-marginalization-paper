...
I have created a package, \texttt{name}\footnote{available HERETKTK}, for evaluating these expressions.
...
If a region of a spectrum contains two clearly distinct absorption lines but the model only allows for a single line, the presence of the un-modeled line will bias the continuum model.

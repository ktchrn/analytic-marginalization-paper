...
\begin{figure}
  ...
  %\footnote{We have chosen this visualization instead of the more typical one where the quantity being varied (in this case SNR) is on the $x$-axis, the outcome (in this case RMSE) is on the $y$-axis, and each curve corresponds to a different class (in this case method) because some of the methods would be indistinguishable over most of parameter space if shown in the more common style.}
  }

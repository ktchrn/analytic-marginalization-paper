...
| Its RMSE is, on average, as good as that of the reference solution for spectra with 0th order continua and 4\% and 10\% greater than the reference solution for spectra with 1st, and 2nd order continua.
| For spectra generated with the simpler continuum parametrizations, the RMSE of the conservative method is greater than the RMSE of parametrization-marginalized solution by 50\% and 40\%.
...
| For 0th, 1st, and 2nd order true parametrizations, the conservative-method SNR divided by the parametrization-marginalized SNR is 1.6, 1.5, and 0.9.
| Assuming the SNR of these spectra is proportional to the square root of integration time, parametrization marignalization requires 0.8 as much time for the 0th and 1st order cases and 1.05 as much time for the 2nd order case.
